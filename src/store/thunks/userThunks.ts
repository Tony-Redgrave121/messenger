...
interface IRegisterArgsSignal extends IRegistrationArgs {
    signal: AbortSignal,
}

export const registration = createAsyncThunk(
    "registration",
    async ({formData, signal}: IRegisterArgsSignal, thunkAPI) => {
        try {
            const response = await AuthService.registration(formData, signal)
