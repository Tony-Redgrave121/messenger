...
class AuthController {
    registration(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const userData = yield authService_1.default.registration(req.body, req.files);
    ...
    login(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const userData = yield authService_1.default.login(req.body);
                if (userData instanceof ApiError_1.default)
                    return res.json(userData);
                res.cookie('refreshToken', userData.refreshToken, { maxAge: 7 * 24 * 60 * 60 * 1000, httpOnly: true });
                return res.json(userData);
    ...
    deleteAccount(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { refreshToken } = req.cookies;
                const token = yield authService_1.default.deleteAccount(refreshToken, req.body.user_id);
                res.clearCookie('refreshToken');
                return res.json(token);
            }
            catch (e) {
