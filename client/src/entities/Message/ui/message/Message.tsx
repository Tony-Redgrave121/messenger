...
import {IMessageFile, IAdaptMessenger, IReaction} from "@appTypes";
import {
    useAppDispatch,
    useAppSelector,
    getTitle,
...
import ReactionsBlock from "../../../Reaction/reactionsBlock/ReactionsBlock";
                        ...
                        <div
                            className={
                                clsx(
                                    ...
                                    (messenger.type === 'channel' && !postId) && style.ChannelMessageContent
                                )
                            }
                        >
                            {message.reply &&
                            ...
                            <div className={style.MessageBlock} onContextMenu={(event) => contextMenu({
                                event,
                                setPosition,
                                setContextMenuState,
                                height: 100
