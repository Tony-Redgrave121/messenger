...
import { HiOutlineArrowLeft, HiOutlineArrowRight, HiOutlinePhoto } from 'react-icons/hi2';
...
const CreateMessenger: FC<IMessengerProps> = ({
    messengerCreation,
