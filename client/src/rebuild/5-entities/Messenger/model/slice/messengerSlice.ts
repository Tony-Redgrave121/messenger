...
import MessengersListSchema from "../types/MessengersListSchema";

interface ILiveUpdatesState {
    messengers: MessengersListSchema[],
...
const messengerSlice = createSlice({
    ...
    initialState,
    reducers: {
        setMessengers(state, action: PayloadAction<MessengersListSchema[]>) {
            state.messengers = action.payload
        },
        addMessenger(state, action: PayloadAction<MessengersListSchema>) {
