...
import EditMessenger from "./editMessenger/EditMessenger";
import useCopy from "@utils/hooks/useCopy";
import {Caption} from "../../../../shared/ui/Caption";
import MembersList from "./editMessenger/editMembers/membersList/MembersList";
        ...
        >
            <Sidebar styles={['RightSidebarContainer']} ref={ref}>
                ...
                <ul className={style.InfoList}>
                    ...
                    <li>
                        <SettingButton
                            foo={() => handleCopy(`${CLIENT_URL}/${entity.type}/${entity.id}`, 'Link copied to clipboard')}
                            text={entity.id}
                            desc={'Link'}
                        >
                            <HiOutlinePaperClip/>
